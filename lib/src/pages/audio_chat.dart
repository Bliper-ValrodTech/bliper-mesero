...
class AudioChatWidget extends StatefulWidget {
  ...
  const AudioChatWidget({required this.audio_url});

  @override
  _AudioChatWidgetState createState() => _AudioChatWidgetState();
}
class _AudioChatWidgetState extends StateX<AudioChatWidget> {
  ...
  Future<void> _init() async {
    ...
    try {
      ...
      await _player.setAudioSource(AudioSource.uri(Uri.parse(widget.audio_url)));
    } catch (e) {
